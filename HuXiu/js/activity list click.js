...
//手风琴即手风琴响应式效果
   ...
   function appendAct(){
        ...
        $.ajax({
            type:"GET",
            url:"EndlesspageHandler.ashx",
            data: { pagenumber: i, pagesize: 2 },                //发送给后台，请求第几页信息，每页信息多大
                //dataType:"json",
            async:true,
            success:function(dat){
                ...
                for(j=0;j<jsonObj.length;j++){
                    ...
                    if(j%2!=0) actText.addClass("activity-textS-2");
                        ...
                        var actTexta=$("<a>").text("更多详情").appendTo(actText);
                }
            },
                //根据后台发来的数据动态添加元素
            error:function(xhr){
